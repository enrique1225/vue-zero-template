    ...
    <div class="login-form login-signin">
      ...
      <b-form class="form" @submit.stop.prevent="onSubmit">
        ...
        >
          ...
          <p class="error" v-if="!$v.form.password.minLength">
        ...
        >
          <b-form-input
            ...
            id="example-input-2"
            name="example-input-2"
            v-model.trim="$v.form.repassword.$model"
            :state="validateState('repassword')"
            placeholder="Password(repeat)"
          ></b-form-input>

          <div class="error" v-if="!$v.form.repassword.sameAsPassword"> Passwords do not match! </div>
        </b-form-group>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      const surname = this.$v.form.username.$model;
      const username = this.$v.form.username.$model;
      const email = this.$v.form.email.$model;
      const password = this.$v.form.password.$model;
      const repassword = this.$v.form.repassword.$model;
